    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600">
          Manage your organization's departments and users efficiently
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <p className="text-gray-600">
            Add, modify, and manage user records. Track personal information, salaries, and department assignments.
          </p>
      ...
      <div className="mt-12 p-6 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl text-white">
        ...
        <p className="text-blue-100">
          Start by creating departments for your organization, then add users and assign them to their respective departments.
        </p>
      </div>
    </div>
  );
